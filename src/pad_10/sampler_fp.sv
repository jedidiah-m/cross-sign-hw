...
//serial parallel correct
    always_comb begin
       serial_correct = 1;
       if(data_in[9*P_BIT_WIDTH-1:8*P_BIT_WIDTH] == 7'b1111111)
          serial_correct = 0;
    end
    ...
    always_comb begin
       ...
       if(data_in[9*P_BIT_WIDTH-1:8*P_BIT_WIDTH] == 7'b1111111)
          parallel_correct = 0;
       if(data_in[8*P_BIT_WIDTH-1:7*P_BIT_WIDTH] == 7'b1111111)
          parallel_correct = 0;
       if(data_in[7*P_BIT_WIDTH-1:6*P_BIT_WIDTH] == 7'b1111111)
          parallel_correct = 0;
       if(data_in[6*P_BIT_WIDTH-1:5*P_BIT_WIDTH] == 7'b1111111)
          parallel_correct = 0;
       if(data_in[5*P_BIT_WIDTH-1:4*P_BIT_WIDTH] == 7'b1111111)
          parallel_correct = 0;
       if(data_in[4*P_BIT_WIDTH-1:3*P_BIT_WIDTH] == 7'b1111111)
          parallel_correct = 0;
       if(data_in[3*P_BIT_WIDTH-1:2*P_BIT_WIDTH] == 7'b1111111)
          parallel_correct = 0;
       if(data_in[2*P_BIT_WIDTH-1:P_BIT_WIDTH] == 7'b1111111)
          parallel_correct = 0;
       if(data_in[P_BIT_WIDTH-1:0] == 7'b1111111)
          parallel_correct = 0;
    end
